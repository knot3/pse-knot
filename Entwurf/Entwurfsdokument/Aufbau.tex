...
\newline
\newline
In das Datenmodell werden die Klassen \class{Knot}, \class{Edge} und \class{Circle} eingeteilt, da diese die darzustellenden Daten enthalten den Controller über Änderungen informieren. Die Präsentation zeigt die Daten in grafischer Form an und informiert die Programmsteuerung über Benutzereingaben. Sie wird von den Klassen \class{PipeModel}, \class{NodeModel} und \class{ArrowModel} repräsentiert.
