...
Das Kompositum gehört zu der Kategorie der Varianten-Muster und werden in unserem Entwurf von den Klassen \class{KnotRenderer}, \class{EdgeMovement}, \interface{IGameScreenComponent}, \class{Menu}, \class{MenuItem}, \class{ColorPicker} und \class{Dialog} dargestellt.
