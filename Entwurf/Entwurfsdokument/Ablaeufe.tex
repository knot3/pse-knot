...
Beim nächsten Update()-Call von XNA wird dann der PostProcessingEffect von \class{CreativeLoadScreen} für ein Überblenden der Menüs z.B. auf \class{FadeEffect} gesetzt und der \class{CreativeMainScreen} deaktiviert, d.h. alle \class{IGameScreenComponent}s von \class{CreativeMainScreen} werden aus der Liste aller \class{IGameScreenComponent} gelöscht. Dann wird \class{CreativeLoadScreen} aktiviert und dessen \class{IGameScreenComponent} in die XNA \xna{IGameComponent}-Liste eingetragen.
\newline
