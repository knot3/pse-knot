...
%justification=raggedright,singlelinecheck=false]{caption}[2008/08/24]
...
%
%\usepackage[hidelinks]{hyperref} % Kein "Roter Kasten"/Hervorhebung von Links
\usepackage{hyperref}
\hypersetup{%
...
\newglossary{BZ}{bzi}{bzo}{Bezeichner}
\makeglossaries
...
\loadglsentries[BZ]{Inhalt/Verzeichnisse/Glossare/Bezeichner}
